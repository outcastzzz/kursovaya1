import os
"""
Django settings for ad_agency_project project.
...
SECRET_KEY = 'django-insecure-+!whznc*!e^q&c^*ksxotuz3x-3fwqxn+ssbi7hacmfb=-^@&&'
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'agency/templates')],  # Добавь эту строку
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
